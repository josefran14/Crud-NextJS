...
export const UserCard = ({data}) => {
  ...
  return (
    ...
    >
      ...
      >
        <Box sx={{width: "100%", display: "flex", alignItems: "center", marginTop: "6px"}}>
          <Box sx={{width: "28%", alignItems: "center", marginLeft: "4px"}}>
            <Button onClick={handleBack}>
              <ArrowBackIcon color="error"/>
            </Button>
          </Box>
        <Typography variant="h6" sx={{ color: "white", width: "72%"}}>
          Details of the user: {data?.data.name}
        </Typography>
        </Box>
        <Box sx={{ display: "flex", justifyContent: "center" }}>
          <Avatar  sx={{ width: "60px", height: "60px", marginTop: "10px", background: "#0b1f33" }}>
            {abreviation}
          </Avatar>
        </Box>
        <CardContent sx={{ display: "flex", flexDirection: "column", alignItems: "center", width: "100%" }}>
          ...
          <Typography sx={{mt: "14px", display: "flex", gap: "6px"}}>
          <Typography sx={{fontWeight: "bold"}}>Username:</Typography> {username}
          </Typography>
          <Typography sx={{mt: "14px", display: "flex", gap: "6px"}}>
          <Typography sx={{fontWeight: "bold"}}>Website:</Typography> {website}
          </Typography>
        </CardContent>
      </Card>
    </Box>
